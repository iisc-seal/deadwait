...
namespace Stubs
{
    public class SystemArrayStub
    {
        ...
        public static TOutput[] ConvertAll<TInput, TOutput>(System.Array thisRef, TInput[] array, Converter<TInput, TOutput> converter)
        {
            return new TOutput[10];
        }
    }
    ...
    /*
    [mscorlib]System.Threading.Tasks.Task::GetAwaiter/*			=   [Stubs]Stubs.TaskHelpers::GetAwaiter/*
    [mscorlib]System.Runtime.CompilerServices.ConfiguredTaskAwaitable.ConfiguredTaskAwaiter::GetAwaiter/*	=	[Stubs]Stubs.RuntimeHelpers::GetAwaiter/*
    */

    //public class TaskHelpers
    //{
    //    public static TaskAwaiter GetAwaiter(Task thisref)
    //    {
    //        TaskAwaiter t = new TaskAwaiter();
    //        t.m_task = thisref;
    //        return t;
    //    }
    //}
    ...
    //    {
    //        ConfiguredTaskAwaitable.ConfiguredTaskAwaiter t = new ConfiguredTaskAwaitable.ConfiguredTaskAwaiter();
    //        Task x = new Task(() => t.ToString());
    //        return t;
    //    }
    //}
