    ...
    {           
        ...
        public static string GetTypeName(Phx.Types.Type type)
        {
            ...
            if (type.IsAggregateType && type.TypeSymbol != null)
            {
                ...
                var v = qualname.Replace("[System.Threading.Tasks]", "[mscorlib]");
                v = v.Replace("[System.Threading.Tasks.Task]", "[mscorlib]");
                v = v.Replace("[System.Threading.Tasks.Task`1]", "[mscorlib]");
                v = v.Replace("[System.Runtime]System.Nullable`1", "[mscorlib]System.Nullable`1");
                return v;
            }
            else
            {
                var v = type.ToString().Replace("[System.Threading.Tasks]", "[mscorlib]");
                v = v.Replace("[System.Threading.Tasks.Task]", "[mscorlib]");
                v = v.Replace("[System.Threading.Tasks.Task`1]", "[mscorlib]");
                v = v.Replace("[System.Runtime]System.Nullable`1", "[mscorlib]System.Nullable`1");
                return v;
        ...
        public static String ConditionCodeToString(int x)
        {
            switch (x)
            {
                case Phx.ConditionCode.False: return "False";
                case Phx.ConditionCode.True: return "True";
                case Phx.ConditionCode.EQ: return "EQ";
                case Phx.ConditionCode.NE: return "NE";
                case Phx.ConditionCode.LT: return "LT";
                case Phx.ConditionCode.LE: return "LE";
                case Phx.ConditionCode.GT: return "GT";
                case Phx.ConditionCode.GE: return "GE";
                case Phx.ConditionCode.ULT: return "ULT";
                case Phx.ConditionCode.ULE: return "ULE";
                case Phx.ConditionCode.UGT: return "UGT";
                case Phx.ConditionCode.UGE: return "UGE";
                case Phx.ConditionCode.FLT: return "FLT";
                case Phx.ConditionCode.FLE: return "FLE";
                case Phx.ConditionCode.FGT: return "FGT";
                case Phx.ConditionCode.FGE: return "FGE";
                case Phx.ConditionCode.FNLT: return "FNLT";
                case Phx.ConditionCode.FNLE: return "FNLE";
                case Phx.ConditionCode.FNGT: return "FNGT";
                case Phx.ConditionCode.FNGE: return "FNGE";
