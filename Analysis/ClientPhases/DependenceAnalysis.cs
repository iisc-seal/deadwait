...
namespace SafetyAnalysis.Purity
{
    ...
    {                    
            ...
            Phx.FunctionUnit funit, Phx.PEModuleUnit moduleUnit)
        {
            ...
            var call = new StaticCall(37, 37, 37, null, methodname, typename, methodsig, new List<string>());
            ...
            //read callee summary
            var summary = (new CalleeSummaryReader(funit, moduleUnit, true)).GetCalleeData(call, data);
            if (summary == null)
