...
namespace SafetyAnalysis.Purity
{
    public class PurityDataUtil
    {
        ...
        public static HeapVertexBase CollapseVertices(PurityAnalysisData data, HeapVertexSet toCollapseSet)
        {
            ...
            //foreach(var vertex in toCollapseSet)
            //{
            //    Console.WriteLine("Adding vertex mapping [collapse] " + vertex + "-->" + rep);
            //    // data.vertexMapping.Add(vertex, rep);
            //    PurityAnalysisPhase.vertexMapping.Add(new Pair<String, HeapVertexBase>("", vertex), rep);
            //}
            return rep;
        }
        ...
        public static void DumpAsDGML(PurityAnalysisData data, string filename, Call appliedCall)
        {
            ...
            {                
                ...
                xmlWriter.WriteAttributeString("ContextID", skcall.instructionContext.ToString());
